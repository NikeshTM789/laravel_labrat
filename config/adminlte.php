        ...
        'Datatables' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => $host.'/packages/datatables/datatables.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => $host.'/packages/datatables/datatables.min.css',
                ],
                [
                    'type' => 'js',
                    'asset' => false,
        ...
        'Summernote' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => $host.'/backend/scripts/summernote_setup.js',
                ],
            ],
        ]
    ],
